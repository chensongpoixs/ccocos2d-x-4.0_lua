...
bool MenuScene::init() {
    ...
    // 开场背景音乐
    CocosDenshion::SimpleAudioEngine::getInstance()->playBackgroundMusic("./mp3/music_menu_bg.mp3", true);
...
void MenuScene::addUI() {
    ...
    menu_bg = Sprite::create("./png/menu_bg.jpg");
	if (!menu_bg)
	{
		...
		if (fp)
		{
			...
			input << "ScreenWidth=" << ScreenWidth << ", ScreenHeight=" << ScreenHeight << "\n";
			input.str().c_str();
			//memcpy(buf, SearchPath, )
			fwrite(input.str().c_str(), input.str().length(), 1, fp);
			fflush(fp);
			fclose(fp);
			fp = NULL;
		}
    ...
    // 游戏标题
    label_title = Sprite::create("./png/game_title.png");
    label_title->setAnchorPoint(Vec2(0.5, 1));
    label_title->setPosition(Vec2(ScreenWidth/2, ScreenHeight-10));
    addChild(label_title);
    
    // 粒子
    ParticleSystemQuad *particle = ParticleSystemQuad::create("./particle/particle_galaxy.plist");
    ...
    // 开始游戏按钮
    item_startgame1 = MenuItemImage::create("./png/btn_gametimer_normal.png", "./png/btn_gametimer_pressed.png", CC_CALLBACK_0(MenuScene::startGameTimer, this));
    item_startgame1->setAnchorPoint(Vec2(1, 0.5));
    item_startgame1->setPosition(Vec2(-15, -20));
    
    item_startgame2 = MenuItemImage::create("./png/btn_gameunlimited_normal.png", "./png/btn_gameunlimited_pressed.png", CC_CALLBACK_0(MenuScene::startGameUnlimited, this));
    item_startgame2->setAnchorPoint(Vec2(0, 0.5));
    item_startgame2->setPosition(Vec2(15, -20));
    
    // 历史记录按钮
    item_history = MenuItemImage::create("./png/btn_history_normal.png","./png/btn_history_pressed.png", CC_CALLBACK_0(MenuScene::openHistory, this));
...
void MenuScene::addHistoryUI() {
    ...
    // 卡通人物
    Sprite *character = Sprite::create("./png/character_win.png");
    ...
    // 按钮
    auto item_limited = MenuItemImage::create("./png/btn_limited_normal.png", "./png/btn_limited_pressed.png", CC_CALLBACK_0(MenuScene::showLimitedRecord, this));
    item_limited->setPosition(Vec2(-30, 0));
    auto item_unlimited = MenuItemImage::create("./png/btn_unlimited_normal.png", "./png/btn_unlimited_pressed.png", CC_CALLBACK_0(MenuScene::showUnLimitedRecord, this));
    item_unlimited->setPosition(Vec2(30, 0));
    
    auto item_back = MenuItemImage::create("./png/btn_back_normal.png", "./png/btn_back_pressed.png", CC_CALLBACK_0(MenuScene::hideHistory, this));
