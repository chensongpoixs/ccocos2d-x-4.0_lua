...
bool Game::init() {
    ...
    this->scheduleUpdate();
    // 开启计时器
    this->schedule(CC_SCHEDULE_SELECTOR(Game::gametimer),  1.0);
    // 开启定时器
    this->schedule(CC_SCHEDULE_SELECTOR(Game::createBaseBallTimer),  3.0);
    // 开启AI干预
    this->schedule(CC_SCHEDULE_SELECTOR(Game::gameObserver), 1.5);
...
void Game::gameOver() {
    ...
    // 停止计时
    this->unschedule(CC_SCHEDULE_SELECTOR(Game::gametimer));
    // 游戏结束音效
    ...
    // 对话框背景
    Sprite *dialog_box = Sprite::create("./png/dialog_box.png");
    dialog_box->setAnchorPoint(Vec2(0.5, 0.5));
    dialog_box->setPosition(Vec2(0, 0));
    gameover_layer->addChild(dialog_box,100001);
    
    // 卡通人物
    Sprite *character = Sprite::create(result ? "./png/character_win.png" : "./png/character_lose.png");
    ...
    // 按钮
    auto item_continue = MenuItemImage::create("./png/btn_continue_normal.png", "./png/btn_continue_pressed.png", CC_CALLBACK_1(Game::reStartGame, this));
    item_continue->setAnchorPoint(Vec2(1, 1));
    item_continue->setPosition(Vec2(-10, 0));
    auto item_back = MenuItemImage::create("./png/btn_menu_normal.png", "./png/btn_menu_pressed.png", CC_CALLBACK_1(Game::back, this));
...
void Game::addUI() {
    ...
    // 开场背景音乐
    CocosDenshion::SimpleAudioEngine::getInstance()->playBackgroundMusic("./mp3/music_game_bg.mp3", true);
    ...
    // 背景层
    bglayer2 = Sprite::create("./png/game_galaxy.jpg");
    ...
    // 粒子
    ParticleSystemQuad *explode = ParticleSystemQuad::create("./particle/particle_bg.plist");
    explode->setPosition(Vec2(ScreenWidth/2, ScreenHeight/2));
    explode->setGlobalZOrder(-100001);
    uilayer->addChild(explode);
    // 云层
    auto menu_cloud = Sprite::create("./png/menu_cloud.png");
    ...
    // 按钮菜单
    // 1.返回按钮
    auto item_back = MenuItemImage::create("./png/button_back.jpg", "./png/button_back.jpg", CC_CALLBACK_1(Game::back, this));
    ...
    // 2.加速按钮
    auto item_dash = MenuItemImage::create("./png/button_dash_normal.jpg", "./png/button_dash_pressed.jpg", CC_CALLBACK_1(Game::dash, this));
    item_dash->setAnchorPoint(Vec2(1,0));
    item_dash->setPosition(Vec2(ScreenWidth-80, 50));
    item_dash->setGlobalZOrder(100000);
    dashTimer = ProgressTimer::create(Sprite::create("./png/button_dash_process.jpg"));
    ...
    // 3.发射按钮
    auto item_shoot = MenuItemImage::create("./png/button_shoot_normal.jpg", "./png/button_shoot_pressed.jpg", CC_CALLBACK_1(Game::shoot, this));
    ...
    // 4.缩放按钮
    auto item_scaleup = MenuItemImage::create("./png/button_add.jpg", "./png/button_add.jpg", CC_CALLBACK_1(Game::scaleup, this));
    item_scaleup->setAnchorPoint(Vec2(0, 0));
    item_scaleup->setPosition(Vec2(0, 0));
    item_scaleup->setGlobalZOrder(100000);
    auto item_scaledown = MenuItemImage::create("./png/button_sub.jpg", "./png/button_sub.jpg", CC_CALLBACK_1(Game::scaledown, this));
...
void Game::back(cocos2d::Ref* pSender) {
    CocosDenshion::SimpleAudioEngine::getInstance()->playEffect("./mp3/effect_click.mp3");
...
void Game::dash(cocos2d::Ref *pSender) {
    ...
    dashCount = 100;
    CocosDenshion::SimpleAudioEngine::getInstance()->playEffect("./mp3/effect_dash.mp3");
    player->speedUp();
}

void Game::shoot(cocos2d::Ref *pSender) {
    // 子弹音效
    CocosDenshion::SimpleAudioEngine::getInstance()->playEffect("./mp3/effect_bullet.mp3");
...
void Game::demonKilled(Demon *demon) {
    ...
    // 音效
    CocosDenshion::SimpleAudioEngine::getInstance()->playEffect("./mp3/effect_explode.mp3");
    // 爆炸粒子
    addParticle("./particle/particle_explode.plist", demon->getPos());
    // 移除demon
...
void Game::playerKilled() {
    // 震动
	CocosDenshion::SimpleAudioEngine::getInstance()->end();//->vibrate();
    // 隐藏
...
bool Game::onTouchBegan(cocos2d::Touch *touch, cocos2d::Event *unused_event) {
    ...
    // 粒子特效
    addParticle("./particle/particle_touch.plist", p);
    return true;
}
